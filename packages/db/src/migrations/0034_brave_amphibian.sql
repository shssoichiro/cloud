CREATE TABLE "auto_model" (
	"auto_model_id" serial PRIMARY KEY NOT NULL,
	"auto_model" text NOT NULL
);
--> statement-breakpoint
CREATE TABLE "mode" (
	"mode_id" serial PRIMARY KEY NOT NULL,
	"mode" text NOT NULL
);
--> statement-breakpoint
DROP VIEW "public"."microdollar_usage_view";--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "mode_id" integer;--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "auto_model_id" integer;--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "market_cost" bigint;--> statement-breakpoint
CREATE UNIQUE INDEX "UQ_auto_model" ON "auto_model" USING btree ("auto_model");--> statement-breakpoint
CREATE UNIQUE INDEX "UQ_mode" ON "mode" USING btree ("mode");--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD CONSTRAINT "microdollar_usage_metadata_mode_id_mode_mode_id_fk" FOREIGN KEY ("mode_id") REFERENCES "public"."mode"("mode_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD CONSTRAINT "microdollar_usage_metadata_auto_model_id_auto_model_auto_model_id_fk" FOREIGN KEY ("auto_model_id") REFERENCES "public"."auto_model"("auto_model_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
