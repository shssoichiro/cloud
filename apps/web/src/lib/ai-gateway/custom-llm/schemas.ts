...
import { ImageResponseArraySchema } from './image';
import { ReasoningDetailArraySchema } from './reasoning-details';
...
export type ChatCompletionChunkChoice = z.infer<
  typeof OpenRouterStreamChatCompletionChunkChoiceSchema
>;
...
export type ChatCompletionChunk = z.infer<typeof OpenRouterStreamChatCompletionChunkSchema>;
